...
pdb_pep_dataset = r"C:\Users\danmo\DanielMonzon\data_prepare\pdb_pep_chain.tsv"
plip_result_filename = r"C:\Users\danmo\Downloads\plip_results.tsv"
...
def load(pdb_pep_dataset,plip_result_filename): #pdb_pep_chain	 #plip_predict_result
	...
	for i in range(df_fasta_pep.shape[0]):
		...
		result_file_name = r"C:\Users\danmo\DanielMonzon\data_prepare\peptide_result\1a0m_A_result.txt"
		#1a0m_A_result.txt
